...
import pe.edu.upc.catchup.activities.AboutArticleActivity;
...
public class ArticlesAdapter extends RecyclerView.Adapter<ArticlesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ArticlesAdapter.ViewHolder holder, int position) {
        ...
        holder.titleTextView.setText(article.getShortTitle());
        holder.moreTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // TODO: Start About Article Activity
                Context context = view.getContext();
                Intent intent = new Intent(context, AboutArticleActivity.class);
                intent.putExtras(article.toBundle());
